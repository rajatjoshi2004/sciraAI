                    ...
                    <div className="p-6 border-b border-neutral-200 dark:border-neutral-800">
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-neutral-600 dark:text-neutral-400">
                                Opus AI is an AI search engine and is not associated with any cryptocurrency, memecoin, or token activities. Beware of impersonators.
                            </DialogDescription>
                        </DialogHeader>
                    </div>
                    ...
                    >
                        ...
                        <motion.div variants={item} className="text-center">
                            <Link href="/" className="inline-flex items-end gap-3 text-5xl font-syne font-bold">
                                <NextImage src="/opus.png" alt="Opus AI Logo" className="h-16 w-16 invert dark:invert-0" width={64} height={64} unoptimized quality={100}/>
                                <span className=''>Opus AI</span>
                            </Link>
                        </motion.div>
                ...
                >
                    <div className="text-center space-y-4 mb-16">
                        ...
                        <p className="text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
                            Watch how Opus AI combines RAG and search grounding to deliver accurate, up-to-date answers from reliable sources.
                        </p>
                    </div>
            ...
            <div className="py-20 px-4 bg-white dark:bg-black border-y border-neutral-200 dark:border-neutral-800">
                ...
                >
                    <div className="text-center space-y-3">
                        ...
                        <p className="text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
                            Join the growing community of developers and researchers using Opus AI.
                        </p>
                    </div>
            ...
            <div className="py-24 px-4 bg-neutral-50 dark:bg-neutral-900/50 border-y border-neutral-200 dark:border-neutral-800">
                <motion.div className="container max-w-5xl mx-auto space-y-16">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
                            Whether you need quick answers or in-depth research, Opus AI adapts to your search needs.
                        </p>
                    </div>
                ...
                <div className="mx-auto max-w-5xl px-4 py-12">
                    <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
                        <div className="flex items-center gap-3">
                            <img src="/opus.png" alt="Opus AI Logo" className="h-8 w-8" />
