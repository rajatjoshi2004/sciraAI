...
const models = [
    { value: "scira-grok-3-mini", label: "", icon: null, iconClass: "", description: "", color: "gray", vision: false, experimental: false, category: "Stable" },
];
...
const ModelSwitcher: React.FC<ModelSwitcherProps> = ({ selectedModel, setSelectedModel, className, showExperimentalModels, attachments, messages, status, onModelSelect }) => {
    ...
    // Since we only have one model and we don't want to show it, return null
    return null;
};
